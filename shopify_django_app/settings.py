...
SECRET_KEY = "v$7hufay9$hgn001pi5(s8-o#m#5&+3ix$zf^o&=0ciqs7i58@"
...
APP_ACCESSTOKEN=os.getenv('APP_ACCESSTOKEN')
STOREFRONT_ACCESSTOKEN = os.getenv('STOREFRONT_ACCESSTOKEN')
